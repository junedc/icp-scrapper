...
<body class="bg-light">
    ...
    <div class="container-fluid px-4">
        <div class="row">
            <div class="col-lg-7 border-end page-column">
                <div class="pt-3 pb-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        if (in_array($status, ['completed', 'in production', 'submitted'])) {
            ...
            <div class="col-lg-5 bg-white no-print api-response-panel" id="apiResponseLogsContainer">
                <div class="p-3">
                        ...
                        @if(isset($api_logs) && count($api_logs) > 0)
                            @foreach($api_logs as $log)
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control bg-dark text-success font-monospace api-response-textarea" rows="40" readonly>{{ json_encode($log['body'], JSON_PRETTY_PRINT) }}</textarea>
                                </div>
                            @endforeach
                        @endif
                    </div>
    ...
    <script>
        function appendApiResponse(method, url, status, body) {
            ...
            logEntry.innerHTML = `
                ...
                <textarea class="form-control bg-dark text-success font-monospace api-response-textarea" rows="18" readonly>${prettyBody}</textarea>
            `;
